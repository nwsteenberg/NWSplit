...
function _wallAroundKeys_extrude_5_300000000000001_outline_fn(){
    return new CSG.Path2D([[339,-191.5],[357,-191.5]]).appendArc([359.5,-189],{"radius":2.5,"clockwise":false,"large":false}).appendPoint([359.5,-171]).appendArc([359.4494897,-170.5],{"radius":2.5,"clockwise":false,"large":false}).appendArc([359.5,-170],{"radius":2.5,"clockwise":false,"large":false}).appendPoint([359.5,-152]).appendArc([359.4494897,-151.5],{"radius":2.5,"clockwise":false,"large":false}).appendArc([359.5,-151],{"radius":2.5,"clockwise":false,"large":false}).appendPoint([359.5,-133]).appendArc([359.4494897,-132.5],{"radius":2.5,"clockwise":false,"large":false}).appendArc([359.5,-132],{"radius":2.5,"clockwise":false,"large":false}).appendPoint([359.5,-114]).appendArc([357,-111.5],{"radius":2.5,"clockwise":false,"large":false}).appendPoint([340.5,-111.5]).appendPoint([340.5,-102.57]).appendArc([338,-100.07],{"radius":2.5,"clockwise":false,"large":false}).appendPoint([321.4281629,-100.07]).appendArc([319,-98.165],{"radius":2.5,"clockwise":false,"large":false}).appendPoint([302.5,-98.165]).appendPoint([302.5,-96.855]).appendArc([300,-94.355],{"radius":2.5,"clockwise":false,"large":false}).appendPoint([282,-94.355]).appendArc([279.5,-96.855],{"radius":2.5,"clockwise":false,"large":false}).appendPoint([279.5,-98.165]).appendPoint([263,-98.165]).appendArc([260.5718371,-100.07],{"radius":2.5,"clockwise":false,"large":false}).appendPoint([244,-100.07]).appendArc([241.5,-102.57],{"radius":2.5,"clockwise":false,"large":false}).appendPoint([241.5,-120.57]).appendArc([241.5505103,-121.07],{"radius":2.5,"clockwise":false,"large":false}).appendArc([241.5,-121.57],{"radius":2.5,"clockwise":false,"large":false}).appendPoint([241.5,-139.57]).appendArc([241.5505103,-140.07],{"radius":2.5,"clockwise":false,"large":false}).appendArc([241.5,-140.57],{"radius":2.5,"clockwise":false,"large":false}).appendPoint([241.5,-158.57]).appendArc([241.5505103,-159.07],{"radius":2.5,"clockwise":false,"large":false}).appendArc([241.5,-159.57],{"radius":2.5,"clockwise":false,"large":false}).appendPoint([241.5,-177.57]).appendArc([244,-180.07],{"radius":2.5,"clockwise":false,"large":false}).appendPoint([260.5,-180.07]).appendPoint([260.5,-180.5573231]).appendPoint([246.6889847,-184.2579734]).appendPoint([243.7917363,-185.0342889]).appendArc([243.7272939,-185.0524692],{"radius":2.5,"clockwise":false,"large":false}).appendPoint([239.5313958,-186.2971076]).appendArc([239.3873062,-186.3446519],{"radius":2.5,"clockwise":false,"large":false}).appendPoint([222.4728391,-192.5010146]).appendArc([220.9786578,-195.7052965],{"radius":2.5,"clockwise":false,"large":false}).appendPoint([227.1350205,-212.6197636]).appendArc([230.3393024,-214.1139449],{"radius":2.5,"clockwise":false,"large":false}).appendPoint([247.1532959,-207.9941516]).appendPoint([261.8927881,-204.0165525]).appendPoint([261.8944109,-204.0161205]).appendPoint([261.8960725,-204.0156721]).appendPoint([275.5408881,-200.3832259]).appendPoint([293.1619312,-197.2761606]).appendArc([295.1898301,-194.3800207],{"radius":2.5,"clockwise":false,"large":false}).appendPoint([291.6588787,-174.355]).appendPoint([298.5,-174.355]).appendPoint([298.5,-175.665]).appendArc([301,-178.165],{"radius":2.5,"clockwise":false,"large":false}).appendPoint([317.5718371,-178.165]).appendArc([320,-180.07],{"radius":2.5,"clockwise":false,"large":false}).appendPoint([336.5,-180.07]).appendPoint([336.5,-189]).appendArc([339,-191.5],{"radius":2.5,"clockwise":false,"large":false}).close().innerToCAG()
.subtract(
    ...
    new CSG.Path2D([[31,-191.5],[49,-191.5]]).appendArc([51.5,-189],{"radius":2.5,"clockwise":false,"large":false}).appendPoint([51.5,-180.07]).appendPoint([68,-180.07]).appendArc([70.4281629,-178.165],{"radius":2.5,"clockwise":false,"large":false}).appendPoint([87,-178.165]).appendArc([89.5,-175.665],{"radius":2.5,"clockwise":false,"large":false}).appendPoint([89.5,-174.355]).appendPoint([96.3411214,-174.355]).appendPoint([92.8101699,-194.3800207]).appendArc([94.8380689,-197.2761606],{"radius":2.5,"clockwise":false,"large":false}).appendPoint([112.4591108,-200.3832256]).appendPoint([126.1039275,-204.0156721]).appendPoint([126.1055891,-204.0161205]).appendPoint([126.1072119,-204.0165525]).appendPoint([140.8467041,-207.9941516]).appendPoint([157.6606977,-214.1139448]).appendArc([160.8649796,-212.6197637],{"radius":2.5,"clockwise":false,"large":false}).appendPoint([167.0213421,-195.7052964]).appendArc([165.527161,-192.5010145],{"radius":2.5,"clockwise":false,"large":false}).appendPoint([148.6126937,-186.344652]).appendArc([148.4686043,-186.2971076],{"radius":2.5,"clockwise":false,"large":false}).appendPoint([144.272706,-185.0524692]).appendArc([144.2087928,-185.0344305],{"radius":2.5,"clockwise":false,"large":false}).appendPoint([141.3115443,-184.2581153]).appendPoint([127.5,-180.5573231]).appendPoint([127.5,-180.07]).appendPoint([144,-180.07]).appendArc([146.5,-177.57],{"radius":2.5,"clockwise":false,"large":false}).appendPoint([146.5,-159.57]).appendArc([146.4494897,-159.07],{"radius":2.5,"clockwise":false,"large":false}).appendArc([146.5,-158.57],{"radius":2.5,"clockwise":false,"large":false}).appendPoint([146.5,-140.57]).appendArc([146.4494897,-140.07],{"radius":2.5,"clockwise":false,"large":false}).appendArc([146.5,-139.57],{"radius":2.5,"clockwise":false,"large":false}).appendPoint([146.5,-121.57]).appendArc([146.4494897,-121.07],{"radius":2.5,"clockwise":false,"large":false}).appendArc([146.5,-120.57],{"radius":2.5,"clockwise":false,"large":false}).appendPoint([146.5,-102.57]).appendArc([144,-100.07],{"radius":2.5,"clockwise":false,"large":false}).appendPoint([127.4281629,-100.07]).appendArc([125,-98.165],{"radius":2.5,"clockwise":false,"large":false}).appendPoint([108.5,-98.165]).appendPoint([108.5,-96.855]).appendArc([106,-94.355],{"radius":2.5,"clockwise":false,"large":false}).appendPoint([88,-94.355]).appendArc([85.5,-96.855],{"radius":2.5,"clockwise":false,"large":false}).appendPoint([85.5,-98.165]).appendPoint([69,-98.165]).appendArc([66.5718371,-100.07],{"radius":2.5,"clockwise":false,"large":false}).appendPoint([50,-100.07]).appendArc([47.5,-102.57],{"radius":2.5,"clockwise":false,"large":false}).appendPoint([47.5,-111.5]).appendPoint([31,-111.5]).appendArc([28.5,-114],{"radius":2.5,"clockwise":false,"large":false}).appendPoint([28.5,-132]).appendArc([28.5505103,-132.5],{"radius":2.5,"clockwise":false,"large":false}).appendArc([28.5,-133],{"radius":2.5,"clockwise":false,"large":false}).appendPoint([28.5,-151]).appendArc([28.5505103,-151.5],{"radius":2.5,"clockwise":false,"large":false}).appendArc([28.5,-152],{"radius":2.5,"clockwise":false,"large":false}).appendPoint([28.5,-170]).appendArc([28.5505103,-170.5],{"radius":2.5,"clockwise":false,"large":false}).appendArc([28.5,-171],{"radius":2.5,"clockwise":false,"large":false}).appendPoint([28.5,-189]).appendArc([31,-191.5],{"radius":2.5,"clockwise":false,"large":false}).close().innerToCAG()
.subtract(
...
.union(
    new CSG.Path2D([[138.25,-101.07],[155.25,-101.07]]).appendPoint([155.25,-94.07]).appendPoint([138.25,-94.07]).appendPoint([138.25,-101.07]).close().innerToCAG()
                ...
                function topL_case_fn() {
                    

                // creating part 0 of case topL
                let topL__part_0 = top_case_fn();

                // make sure that rotations are relative
                let topL__part_0_bounds = topL__part_0.getBounds();
                let topL__part_0_x = topL__part_0_bounds[0].x + (topL__part_0_bounds[1].x - topL__part_0_bounds[0].x) / 2
                let topL__part_0_y = topL__part_0_bounds[0].y + (topL__part_0_bounds[1].y - topL__part_0_bounds[0].y) / 2
                topL__part_0 = translate([-topL__part_0_x, -topL__part_0_y, 0], topL__part_0);
                topL__part_0 = rotate([0,0,0], topL__part_0);
                topL__part_0 = translate([topL__part_0_x, topL__part_0_y, 0], topL__part_0);

                topL__part_0 = translate([0,0,0], topL__part_0);
                let result = topL__part_0;
                
            

                // creating part 1 of case topL
                let topL__part_1 = _rightSubstitution_extrude_100_outline_fn();

                // make sure that rotations are relative
                let topL__part_1_bounds = topL__part_1.getBounds();
                let topL__part_1_x = topL__part_1_bounds[0].x + (topL__part_1_bounds[1].x - topL__part_1_bounds[0].x) / 2
                let topL__part_1_y = topL__part_1_bounds[0].y + (topL__part_1_bounds[1].y - topL__part_1_bounds[0].y) / 2
                topL__part_1 = translate([-topL__part_1_x, -topL__part_1_y, 0], topL__part_1);
                topL__part_1 = rotate([0,0,0], topL__part_1);
                topL__part_1 = translate([topL__part_1_x, topL__part_1_y, 0], topL__part_1);

                topL__part_1 = translate([0,0,-50], topL__part_1);
                result = result.subtract(topL__part_1);
