...
// Pads
fp.push(`(pad "1" thru_hole circle (at 0 ${flipN(flip, -6.35)} ${flipR(flip, p.r + 0)}) (size 1.7 1.7) (drill 1) (layers "*.Cu" "*.Mask") (remove_unused_layers no) (thermal_bridge_angle 90)  ${p.P1})`);
fp.push(`(pad "2" thru_hole rect (at 0 ${flipN(flip, -3.81)} ${flipR(flip, p.r + 0)}) (size 1.7 1.7) (drill 1) (layers "*.Cu" "*.Mask") (remove_unused_layers no) (thermal_bridge_angle 45)  ${p.P2})`);
fp.push(`(pad "3" thru_hole circle (at 0 ${flipN(flip, -1.27)} ${flipR(flip, p.r + 0)}) (size 1.7 1.7) (drill 1) (layers "*.Cu" "*.Mask") (remove_unused_layers no)  ${p.P3})`);
fp.push(`(pad "4" thru_hole circle (at 0 ${flipN(flip, 1.27)} ${flipR(flip, p.r + 0)}) (size 1.7 1.7) (drill 1) (layers "*.Cu" "*.Mask") (remove_unused_layers no)  ${p.P4})`);
fp.push(`(pad "5" thru_hole circle (at 0 ${flipN(flip, 3.81)} ${flipR(flip, p.r + 0)}) (size 1.7 1.7) (drill 1) (layers "*.Cu" "*.Mask") (remove_unused_layers no)  ${p.P5})`);
fp.push(`(pad "6" thru_hole circle (at 0 ${flipN(flip, 6.35)} ${flipR(flip, p.r + 0)}) (size 1.7 1.7) (drill 1) (layers "*.Cu" "*.Mask") (remove_unused_layers no)  ${p.P6})`);
