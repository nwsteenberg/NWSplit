...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------|                            |------+------+------+------+------+------|
   * | L2   |   Z  |   X  |   C  |   V  |   B  |                            |   N  |   M  |   ,  |   .  |   /  | RSFT |
   * `---------------------------+------+------+------|              |------+------+------+---------------------------`
   *                             | LALT | Space| L1   |              | Enter| Bspc | RALT |
   *                             `------|------|------|              |------|------|------'
   */
    [_QWERTY] = LAYOUT(
        ...
        L_2,     KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,                             KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RGUI, 
    ...
    [_LAYER1] = LAYOUT(
        ...
        KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                          KC_HOME, KC_PGDN, KC_PGUP, KC_END,  KC_TRNS, KC_RBRC,  
